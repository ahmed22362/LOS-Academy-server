...
<body
  ...
  <div style="display: none;">A request to reset password was received from your LOS Academy Account</div>
                  ...
                  <tr>
                    <td class="sm-px-24"
                      ...
                      <p style="margin: 0 0 24px;">
                        This is the password reset OTP you requested from LOS Academy. Use to reset your LOS Academy account password.
                      </p>
  ...
  const text = `
        Reset Password, You recently requested to reset your password for your LOS Academy account. Copy and paste it for reset password:
        ${token}
